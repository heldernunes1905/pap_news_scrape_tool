        ...
        $(document).on("click", "#richText-Image button.btn", function(event) {
            ...
            if($form.attr("data-editor") === editorID) {
                ...
                if(!url) {
                    ...
                    if(settings.useSingleQuotes === true) {
                        if(align === "center") {
                            html = "<div style='text-align:center;'><img src='" + url + "' id='img'></div>";
                        } else {
                            html = "<img src='" + url + "' align='" + align + "' id='img'>";
                        }
                    } else {
                        if(align === "center") {
                            html = '<div style="text-align:center;"><img src="' + url + '" id ="img"></div>';
                    ...
                    if(settings.useSingleQuotes === true) {
                        ...
                        if(align === "right") {
                            ...
                            html = '<img src="' + url + '" align="' + align + '" id="img" style="width:100%">';
                        }
                    }
                    restoreSelection(editorID, true);
                    var $editNode = $('.richText-editNode');
